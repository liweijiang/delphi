...
def main_get_accuracy(base_path, data_split, training_data_type, round_ids=None, check_points=None, is_print=False):
    ...
    for check_point in check_points: # check_points
        ...
        for round_id in round_ids:
            ...
            inputs, targets = get_gold_class(round_id, data_split, training_data_type)
        ...
        print(f"round {str(round_ids)} {check_point}: f1 -- {f1} | accuracy -- {acc}")
...
def main_r1_yesno(training_data, training_data_type):
    ...
    print(training_data)
    for base_model in ["v11-delphi-declare", "unicorn-pt"]: # "v11-delphi-declare", "v10-delphi" "v10-delphi", "v9-delphi", "unicorn-pt", "11B"
        print("=" * 10, base_model)
        ...
        check_points = None
        main_get_accuracy(base_path, "validation", training_data_type, round_ids=[1], check_points=check_points, is_print=False)
        # check_points = base_model_2_ckpt[training_data][base_model]
        # main_get_accuracy(base_path, "test", training_data_type, round_ids=[1, 2, 3, 4], check_points=check_points, is_print=True)
...
def main_all_yesno(training_data, training_data_type):
    ...
    for base_model in ["v11-delphi-declare",
                       "unicorn-pt"]:  # "v11-delphi-declare", "v10-delphi" "v10-delphi", "v9-delphi", "unicorn-pt", "11B"
        print("=" * 10, base_model)
        base_path = f"ai2-tpu-europe-west4/projects/liweij/mosaic-commonsense-morality/model/finetune/{base_model}/{training_data}/lr-0.0002_bs-16/"
        check_points = None
        main_get_accuracy(base_path, "validation", training_data_type, round_ids=[1, 2, 3, 4], check_points=check_points, is_print=False)
        # check_points = base_model_2_ckpt[training_data][base_model]
        # main_get_accuracy(base_path, "test", training_data_type, round_ids=[1, 2, 3, 4], check_points=check_points, is_print=True)
...
if __name__ == "__main__":
    # main_r1_yesno("dynahate_round_1_yesno_100_shot")
    # main_r1_yesno("dynahate_all_yesno")
    # main_r1_yesno("dynahate_all_yesno_100_shot")

    # main_r1_yesno("dynahate_round_1_yesno", "yesno")
    # main_r1_yesno("dynahate_round_1_yesno_class_only", "yesno_class_only")
    # main_r1_yesno("dynahate_round_1_discriminate", "discriminate")
    # main_r1_yesno("dynahate_round_1_saying", "saying")
    # main_r1_yesno("dynahate_round_1_fair", "fair")
    # main_r1_yesno("dynahate_round_1_nondiscriminate", "nondiscriminate")
    # print("-" * 200)
    #
    # main_r1_yesno("dynahate_round_1_yesno_100_shot", "yesno")
    # main_r1_yesno("dynahate_round_1_yesno_class_only_100_shot", "yesno_class_only")
    # main_r1_yesno("dynahate_round_1_discriminate_100_shot", "discriminate")
    # print("-" * 200)
    #
    # main_all_yesno("dynahate_all_yesno", "yesno")
    # main_all_yesno("dynahate_all_yesno_class_only", "yesno_class_only")
    # main_all_yesno("dynahate_all_discriminate", "discriminate")
    # main_all_yesno("dynahate_all_saying", "saying")
    # main_all_yesno("dynahate_all_fair", "fair")
    # main_all_yesno("dynahate_all_nondiscriminate", "nondiscriminate")
    # print("-" * 200)
    #
    # main_all_yesno("dynahate_all_yesno_100_shot", "yesno")
    # main_all_yesno("dynahate_all_yesno_class_only_100_shot", "yesno_class_only")
    # main_all_yesno("dynahate_all_discriminate_100_shot", "discriminate")
